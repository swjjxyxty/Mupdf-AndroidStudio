#ifndef _FITZ_STORE_H
#define _FITZ_STORE_H
...
/*
	Resource store
	 ...
	 stores decoded "objects" into a store for potential reuse.
	If the size of the store gets too big, objects stored within it can
	be evicted and freed to recover space. When  comes to decode
