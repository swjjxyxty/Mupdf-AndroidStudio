#ifndef _FITZ_CONTEXT_H
#define _FITZ_CONTEXT_H
...
/*
	...
	etc. Most functions in  take a context argument to be
	...
	when using  in a single-threaded applications. The
...
*/
fz_context *fz_new_context_imp(fz_alloc_context *alloc, fz_locks_context *locks,
                               unsigned int max_store, const char *version);
...
/*
	Locking functions
	 ...
	 is kept deliberately free of any knowledge of particular
...
/*
	...
	All calls to s allocator functions pass through to the
	...
	If the underlying allocator fails,  attempts to make room for
